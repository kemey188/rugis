...
const int  PREFETCH_HINT_T0 = 3;  // More temporal locality
const int  PREFETCH_HINT_T1 = 2;
const int  PREFETCH_HINT_T2 = 1;  // Less temporal locality
const int  PREFETCH_HINT_NTA = 0; 
